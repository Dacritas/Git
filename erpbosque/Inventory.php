...
class Inventory {
	...
	public function getCustomerList(){		
		...
		while( $customer = mysqli_fetch_assoc($result) ) {		
			...
			$customerRows[] = '<button type="button" name="update" id="'.$customer["id"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$customerRows[] = '<button type="button" name="delete" id="'.$customer["id"].'" class="btn btn-danger btn-xs delete" >Eliminar</button>';
...
public function saveCustomer() {		
	...
	public function getCategoryList(){		
		...
		while( $category = mysqli_fetch_assoc($result) ) {		
			...
			$categoryRows[] = $status;			
			$categoryRows[] = '<button type="button" name="update" id="'.$category["categoryid"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$categoryRows[] = '<button type="button" name="delete" id="'.$category["categoryid"].'" class="btn btn-danger btn-xs delete" >Eliminar</button>';
	...
	public function getBrandList(){				
		...
		while( $brand = mysqli_fetch_assoc($result) ) {			
			...
			$brandRows[] = $status;
			$brandRows[] = '<button type="button" name="update" id="'.$brand["id"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$brandRows[] = '<button type="button" name="delete" id="'.$brand["id"].'" class="btn btn-danger btn-xs delete" data-status="'.$brand["status"].'">Eliminar</button>';
			$brandData[] = $brandRows;
		}
		$output = array(
			"draw"				=>	intval($_POST["draw"]),
	...
	public function getProductList(){				
		...
		while( $product = mysqli_fetch_assoc($result) ) {			
			...
			$productRow[] = $status;
			$productRow[] = '<button type="button" name="view" id="'.$product["pid"].'" class="btn btn-info btn-xs view">Ver</button>';
			$productRow[] = '<button type="button" name="update" id="'.$product["pid"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$productRow[] = '<button type="button" name="delete" id="'.$product["pid"].'" class="btn btn-danger btn-xs delete" data-status="'.$product["status"].'">Eliminar</button>';
	...
	public function getSupplierList(){		
		...
		while( $supplier = mysqli_fetch_assoc($result) ) {	
			...
			$supplierRows[] = $status;			
			$supplierRows[] = '<button type="button" name="update" id="'.$supplier["supplier_id"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$supplierRows[] = '<button type="button" name="delete" id="'.$supplier["supplier_id"].'" class="btn btn-danger btn-xs delete" >Eliminar</button>';
	...
	public function addSupplier() {		
		$sqlInsert = "
			...
			VALUES ('".$_POST['supplier_name']."', '".$_POST['mobile']."', '".$_POST['address']."')";		Active;
		mysqli_query($this->dbConnect, $sqlInsert);
	...
	public function listPurchase(){		
		$sqlQuery = "SELECT ph.purchase_id, p.pname, ph.quantity, s.supplier_name FROM ".$this->purchaseTable." as ph
		...
		while( $purchase = mysqli_fetch_assoc($result) ) {			
			...
			$productRow[] = '<button type="button" name="update" id="'.$purchase["purchase_id"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$productRow[] = '<button type="button" name="delete" id="'.$purchase["purchase_id"].'" class="btn btn-danger btn-xs delete">Eliminar</button>';
	...
	public function listOrders(){		
		...
		while( $order = mysqli_fetch_assoc($result) ) {			
			...
			$orderRow[] = $order['name'];			
			$orderRow[] = '<button type="button" name="update" id="'.$order["order_id"].'" class="btn btn-warning btn-xs update">Actualizar</button>';
			$orderRow[] = '<button type="button" name="delete" id="'.$order["order_id"].'" class="btn btn-danger btn-xs delete">Eliminar</button>';
			$orderData[] = $orderRow;
